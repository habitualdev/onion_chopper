...
gPatterns = {
    smbanner = { "\254SMB", 4, gSfAppIdSMB},
    smbanner1 = { "\255SMB", 4, gSfAppIdSMB},
}

gFastPatterns = {
    {DC.ipproto.tcp, gPatterns.smbanner},
...
function DetectorValidator()
    ...
    if ((dir == 1) and
        (size >= 10) and
        ((gDetector:memcmp(gPatterns.smbanner[1], #gPatterns.smbanner[1], gPatterns.smbanner[2]) == 0) or 
        (gDetector:memcmp(gPatterns.smbanner1[1], #gPatterns.smbanner1[1], gPatterns.smbanner1[2]) == 0)))
    then
