...
gPatterns = {
    clientPattern = {'\084\016\004\000', 0 , gSfAppIdLINEMEDIA},
}

gFastPatterns = {
    {DC.ipproto.tcp, gPatterns.clientPattern},
}
...
function client_validate()
    ...
    if ( dir == 0 and size == 4) then
        if (gDetector:memcmp(gPatterns.clientPattern[1], #gPatterns.clientPattern[1], gPatterns.clientPattern[2]) == 0) then
