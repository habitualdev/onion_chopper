...
gPatterns = {
    channel_1 = {'\128\000', 0, gSfAppIdTURNChannel},
    channel_2 = {'\100\000', 0, gSfAppIdTURNChannel},
    channel_3 = {'\136\012', 0, gSfAppIdTURNChannel},
}
...
function DetectorValidator()
    ...
    if (dir == 1 and 
        size > 4 and 
        srcPort == 2051 and 
       (DC.checkPattern(gDetector, gPatterns.channel_1) or
        DC.checkPattern(gDetector, gPatterns.channel_2) or 
        DC.checkPattern(gDetector, gPatterns.channel_3))) 
    then
